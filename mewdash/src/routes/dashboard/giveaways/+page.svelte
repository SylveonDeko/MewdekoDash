...
<script lang="ts">
  ...
  function handleMessageCountChange(event: Event) {
    ...
    if (value < BigInt(0)) {
      ...
      showNotificationMessage(
        "The required message count cannot be negative.",
        "error",
      );
    } else {
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="flex flex-col">
            <label for="giveaway-item" class="mb-2 font-medium text-gray-300">
              Giveaway Item
            </label>
            <input
              id="giveaway-item"
          ...
          <div class="flex flex-col">
            <label for="winners-count" class="mb-2 font-medium text-gray-300">
              Number of Winners
            </label>
            <input
              id="winners-count"
          ...
          <div class="flex flex-col md:col-span-2">
            <label for="channel-id" class="mb-2 font-medium text-gray-300">
              Channel ID
            </label>
            <input
              id="channel-id"
          ...
          <div class="flex flex-col md:col-span-2">
            <label for="required-roles" class="mb-2 font-medium text-gray-300">
              Required Roles
            </label>
            <MultiSelectDropdown
              id="required-roles"
          ...
          <div class="flex flex-col md:col-span-2">
            <label for="message-count" class="mb-2 font-medium text-gray-300">
        ...
        <div class="flex flex-col items-center mt-8">
          <fieldset class="w-full">
            ...
            >
              <button
                type="button"
                class="w-full md:w-auto px-6 py-2 text-sm font-medium rounded-md {entryMethod ===
                'reaction'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-700 text-gray-300 hover:bg-gray-600'} focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          ...
          <li class="bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            >
              ...
              <svg
                ...
                class="h-6 w-6 text-blue-500 transform {expandedGiveaway ===
                giveaway.id
                  ? 'rotate-180'
            ...
            {#if expandedGiveaway === giveaway.id}
              <div transition:slide class="mt-6 space-y-4 text-gray-300">
                ...
                {/if}
                <p>
                  <span class="font-medium">Message Count Requirement:</span>
                  {giveaway.messageCountReq.toString()}
                </p>
                <p>
