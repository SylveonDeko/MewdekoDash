...
>
  <div class="space-y-5 text-center text-left">
    ...
    <p>
      ...
      data we collect from you when you use Mewdeko, our Discord bot.
    </p>
    ...
    <p>Mewdeko securely stores your data at Hetzner using encrypted sql.</p>
    <p>
      Mewdeko will keep your data for 30 Days (or more depending on the use).
