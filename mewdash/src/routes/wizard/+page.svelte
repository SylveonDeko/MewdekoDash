  ...
  const featureCategories = [
    {
      ...
      features: [
        ...
        },
        {
          id: "rolegreets",
          title: "Role Messages",
          description: "Greet members when they get roles (perfect for verification systems)",
          icon: "fa-tag",
          recommended: true,
          difficulty: "easy" as const
        },
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          id: "giveaways",
          title: "Giveaways",
          description: "Host contests and events",
          icon: "fa-gift",
          recommended: false,
          difficulty: "easy" as const
        }
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          description: "Bot responds to keywords automatically",
          icon: "fa-envelope",
          recommended: false,
          difficulty: "medium" as const
        }
        ...
        {#if selectedFeatures.length > 0}
          <div class="text-center p-4 rounded-lg border"
            ...
            <p style="color: {$colorStore.text};">
              <span class="font-semibold">{selectedFeatures.length}</span>
          ...
          <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <div class="flex items-center gap-3 mb-3">
                          <span id="welcome-channel-label" class="block text-sm font-medium"
                                style="color: {$colorStore.text};">Welcome Channel{featureConfigs.multigreets.applyToMultiple ? 's' : ''}</span>
                          <span id="input-typecheckbox-bindcheckedfeatureconfigsmultig-label"
                        ...
                        {#if featureConfigs.multigreets.applyToMultiple}
                          <DiscordSelector
                            ...
                            aria-labelledby="welcome-channel-label" multiple={true} />
                      ...
                      <div>
                        <div class="flex items-center justify-between mb-2">
                          <label for="welcome-message" class="text-sm font-medium" style="color: {$colorStore.text};">Welcome
                            Message</label>
                          <label
                            class="flex items-center gap-3 text-sm cursor-pointer p-2 rounded-lg transition-all hover:opacity-50"
                        ...
                        {#if featureConfigs.multigreets.useRichMessage}
                          <div class="mt-3 space-y-4">
                            ...
                            {#if (featureConfigs.multigreets.embeds?.length > 0) || (featureConfigs.multigreets.components?.length > 0) || featureConfigs.multigreets.message.trim()}
                              <div>
                                <h4 class="text-sm font-medium mb-2" style="color: {$colorStore.text};">Live
                                  Preview</h4>
                                <div class="border rounded-lg overflow-hidden"
                                     style="border-color: {$colorStore.primary}20;">
                                  <PreviewCard
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="space-y-4">
                      <div>
                        <span id="role-greet-role-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Role to Greet For</span>
                        <DiscordSelector type="role" options={availableRoles}
                                         bind:selected={featureConfigs.rolegreets.roleId}
                                         placeholder="Choose role to congratulate..."
                                         aria-labelledby="role-greet-role-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">When members get this role, they'll
                          receive a congratulations message</p>
                      </div>
                      <div>
                        <span id="role-greet-channel-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Congratulations Channel</span>
                        <DiscordSelector type="channel" options={availableChannels}
                                         bind:selected={featureConfigs.rolegreets.channelId}
                                         placeholder="Choose where to send congratulations..."
                                         aria-labelledby="role-greet-channel-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">This channel will receive role
                          congratulations messages</p>
                      </div>
                      <div>
                        <div class="flex items-center justify-between mb-2">
                          <label for="role-greet-message" class="text-sm font-medium"
                                 style="color: {$colorStore.text};">Congratulations Message</label>
                          <label
                            class="flex items-center gap-3 text-sm cursor-pointer p-2 rounded-lg transition-all hover:opacity-50"
                            style="background: {$colorStore.primary}05;">
                            <div class="relative">
                        ...
                        {#if featureConfigs.rolegreets.useRichMessage}
                          <div class="mt-3 space-y-4">
                            ...
                            {#if (featureConfigs.rolegreets.embeds?.length || 0) > 0}
                              <div class="space-y-4">
                                <h4 class="text-sm font-medium" style="color: {$colorStore.text};">Congratulations
                                  Embeds</h4>
                        ...
                        <p class="text-xs mt-2" style="color: {$colorStore.muted};">Use %user.mention% for username,
                          %role.name% for role name</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {:else if featureId === 'starboard'}
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    <h3 class="text-lg font-semibold mb-4" style="color: {$colorStore.text};">Starboard
                      Configuration</h3>
                    <div class="space-y-4">
                      <div>
                        <span id="starboard-channel-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Starboard Channel</span>
                        <DiscordSelector type="channel" options={availableChannels}
                                         bind:selected={featureConfigs.starboard.channelId}
                                         placeholder="Channel for popular messages..."
                                         aria-labelledby="starboard-channel-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">Messages with enough reactions will
                          be posted here</p>
                      </div>
                      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label for="star-threshold" class="block text-sm font-medium mb-2"
                                 style="color: {$colorStore.text};">Star Threshold</label>
                          <input id="star-threshold" type="number" min="1" max="20"
                                 class="w-full px-3 py-2 rounded-lg border"
                                 style="background: {$colorStore.primary}08; border-color: {$colorStore.primary}30; color: {$colorStore.text}"
                                 bind:value={featureConfigs.starboard.threshold}>
                          <p class="text-xs mt-1" style="color: {$colorStore.muted};">Reactions needed to reach
                            starboard</p>
                        </div>
                        <div>
                          <label for="star-emoji" class="block text-sm font-medium mb-2"
                                 style="color: {$colorStore.text};">Star Emoji</label>
                          <input id="star-emoji" type="text" maxlength="2"
                                 class="w-full px-3 py-2 rounded-lg border text-center"
                                 style="background: {$colorStore.primary}08; border-color: {$colorStore.primary}30; color: {$colorStore.text}"
                                 bind:value={featureConfigs.starboard.emoji} placeholder="⭐">
            ...
            {:else if featureId === 'xp'}
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    <h3 class="text-lg font-semibold mb-4" style="color: {$colorStore.text};">XP & Leveling
                      Settings</h3>
                    <div class="space-y-4">
                      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          <label for="xp-text-rate" class="block text-sm font-medium mb-2"
                                 style="color: {$colorStore.text};">XP per Message</label>
                          <input id="xp-text-rate" type="number" min="1" max="10"
                                 class="w-full px-3 py-2 rounded-lg border"
                                 style="background: {$colorStore.primary}08; border-color: {$colorStore.primary}30; color: {$colorStore.text}"
                                 bind:value={featureConfigs.xp.textRate}>
                          <p class="text-xs mt-1" style="color: {$colorStore.muted};">XP gained per text message
                            (recommended: 3)</p>
                        </div>
                        <div>
                          <label for="xp-voice-rate" class="block text-sm font-medium mb-2"
                                 style="color: {$colorStore.text};">Voice XP Rate</label>
                          <input id="xp-voice-rate" type="number" min="1" max="10"
                                 class="w-full px-3 py-2 rounded-lg border"
                                 style="background: {$colorStore.primary}08; border-color: {$colorStore.primary}30; color: {$colorStore.text}"
                                 bind:value={featureConfigs.xp.voiceRate}>
                          <p class="text-xs mt-1" style="color: {$colorStore.muted};">XP gained per minute in voice
                            (recommended: 2)</p>
                        </div>
                      </div>
                      <div>
                        <span id="xp-level-channel-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Level Up Channel (Optional)</span>
                        <DiscordSelector type="channel" options={availableChannels}
                                         bind:selected={featureConfigs.xp.levelChannelId}
                                         placeholder="Channel for level up announcements..."
                                         aria-labelledby="xp-level-channel-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">Where to announce when members level
                          up (leave empty for no announcements)</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="space-y-4">
                      <div>
                        <span id="log-channel-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">General Log Channel</span>
                        <DiscordSelector type="channel" options={availableChannels}
                                         bind:selected={featureConfigs.logging.channelId}
                                         placeholder="Choose channel for server logs..."
                                         aria-labelledby="log-channel-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">Member joins, leaves, and other
                          server events will be logged here</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="space-y-4">
                      <div>
                        <span id="auto-role-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Member Role (Optional)</span>
                        <DiscordSelector type="role" options={availableRoles}
                                         bind:selected={featureConfigs.administration.autoRoleId}
                                         placeholder="Role to give new members..." aria-labelledby="auto-role-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">New members will automatically
                          receive this role when they join</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="space-y-4">
                      <div>
                        <span id="suggestions-channel-label" class="block text-sm font-medium mb-2"
                              style="color: {$colorStore.text};">Suggestions Channel</span>
                        <DiscordSelector type="channel" options={availableChannels}
                                         bind:selected={featureConfigs.suggestions.channelId}
                                         placeholder="Channel for member suggestions..."
                                         aria-labelledby="suggestions-channel-label" />
                        <p class="text-xs mt-1" style="color: {$colorStore.muted};">Members can submit suggestions and
                          vote on them here</p>
                      </div>
                    </div>
                  </div>
            ...
            {:else}
              ...
              <div class="text-center py-12">
                ...
                <div class="p-6 rounded-xl border max-w-lg mx-auto"
                     style="background: {$colorStore.primary}08; border-color: {$colorStore.primary}25;">
