...
<header class="py-12 px-4 sm:px-12 flex flex-col items-center bg-mewd-light-grey">
  ...
  <div class="inline-flex font-bold">
    <a
       class="text-2xl px-4 py-2 rounded-l-full border border-r-0 hover:bg-mewd-dark-yellow mt-12 bg-mewd-yellow text-mewd-white shadow shadow-yellow-300"
    ...
    <a
      class="text-2xl px-4 py-2 border border-x-0 mt-12 hover:bg-mewd-dark-yellow bg-mewd-yellow text-mewd-white"
      href="https://ko-fi.com/mewdeko"
      target="_blank" rel="noreferrer">Donate</a>
    <a class="text-2xl px-4 py-2 rounded-r-full border border-l-0 mt-12 hover:bg-mewd-dark-yellow bg-mewd-yellow text-mewd-white"
  ...
  <div class="pt-12 pb-24 md:px-6 lg:px-12 max-w-[130rem]">
    ...
    <FluidContainer breakpoints='{["md", "xl"]}'>
      ...
      <Interactable
        ...
        description="With a team that actually cares about you,
                                    we try to help out in the best way possible!
                                    Also don't be afraid to dm Sylveon for bot support, I don't bite!"
        slot="element-2"
      ...
      <Interactable
        ...
        description="Our bot is completely open source with an agplv3 license (to combat code resellers)!
                                    We have selfhost guides/scripts on the repo as well!"
        slot="element-3"
        title="Open Source"
      >
