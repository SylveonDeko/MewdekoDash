...
<sveltekit:body>
    <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3" style="background: rgb(45,44,56);">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span
                ...
                style="background: rgb(120, 101, 0);"><img alt="Mewdeko Avatar" class="rounded-circle img-fluid"
                                                           height="47" src="https://cdn.mewdeko.tech/Mewdeko.png"
    ...
    <div>
        <h1 class="text-center"><br><br>Auth Code Receiver</h1>
        <h3 class="text-center">Your Discord Auth Code is&nbsp;<code class="code" id="code-spot"
                                                                     style="color: rgb(147,128,24);">%codehere%</code>.
            Run the command&nbsp;<code style="color: rgb(147,128,24);">.auth</code>&nbsp;in any server to finish
            authorizing.</h3>
    </div>
    <h4 class="fw-bold text-center"><br><br><br>Do NOT, and I repeat, do NOT, give this code to anyone else. As
        depending on how the bot is setup, it can be used to impersonate you.</h4>
