...
<sveltekit:body>
    ...
    <div>
        <h4 class="text-center" style="padding: 0;"><a href="https://eb.mewdeko.tech" target="_blank"><br><br>Embed
            Builder<br></a></h4>
        <h4 class="text-center"><br><a href="https://blog.mewdeko.tech/placeholders"
                                       target="_blank">Placeholders<br></a></h4>
        <h4 class="text-center" style="padding: 0;"><br><a href="https://discord.gg/mewdeko" target="_blank">Support
            Server<br></a></h4>
        <h4 class="text-center" style="padding: 0;"><br><a href="https://github.com/SylveonDeko/Mewdeko"
                                                           target="_blank">Source Code<br></a></h4>
    </div>
