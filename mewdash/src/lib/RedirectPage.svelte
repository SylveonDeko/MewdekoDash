...
<div
  class="flex flex-col justify-center place-items-center space-y-6 h-screen w-screen bg-mewd-dark-grey px-6 text-mewd-white"
>
  ...
  <div>
    <p class="text-center text-lg">
      You should be automatically redirected to "{to}" in {count ?? "a few"}
      seconds.
    </p>
    <p class="text-center text-lg">
      Click
