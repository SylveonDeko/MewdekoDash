        ...
        <div class="flex justify-center items-center space-x-[-24px] p-7">
            {#each guilds as guild (guild.Name)}
                <div class="relative group transform transition-all duration-200 hover:-translate-y-2">
                    ...
                    <div
                            class="absolute hidden z-10 group-hover:flex items-center justify-center px-2 py-1 text-lg text-white rounded bg-gray-600 whitespace-nowrap bottom-14 left-1/2 transform -translate-x-1/2">{truncateStringToLength(guild.Name, MAX_GUILD_NAME_LENGTH)}
