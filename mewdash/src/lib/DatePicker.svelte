...
<div class="w-full bg-gray-800 p-4 rounded-lg shadow-lg">
  <div class="flex flex-col space-y-4">
    <div>
      <label
        for={`${id}-date-input`}
        class="block text-sm font-medium text-gray-300 mb-1">Date</label
      >
      <input
        id={`${id}-date-input`}
        type="date"
    ...
    <div>
      <label
        for={`${id}-time-input`}
        class="block text-sm font-medium text-gray-300 mb-1">Time</label
      >
      <button
        type="button"
        id={`${id}-time-input`}
  ...
  {#if showTimePicker}
    ...
    >
      <div class="flex justify-between items-center mb-4">
        ...
        <span class="text-2xl font-bold text-white" aria-label="Current hours"
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <span class="text-2xl font-bold text-white" aria-label="Current minutes"
