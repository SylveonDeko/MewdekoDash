...
{#if variant === 'button'}
  <!-- Desktop Button -->
  <button
    class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg group"
...
{:else if variant === 'compact'}
  <!-- Compact Button -->
  <button
    class="flex items-center gap-2 px-3 py-2 rounded-lg transition-all hover:scale-[1.02]"
...
{:else if variant === 'mobile'}
  ...
  <button aria-label="Button action"
          class="flex items-center justify-center w-10 h-10 rounded-xl transition-all hover:scale-[1.02]"
